...
namespace DTO
{
    public class SanPhamDTO
    {
        ...
        //
        public SanPhamDTO() { }
        public SanPhamDTO(String maSP, String tenSP, String mau, Int32 kichThuoc, String anhMinhHoa, String moTa, Int32 giaTien, Int32 soLuongTonKho, String maLoaiSP, Boolean trangThai = true)
        {
            this.MaSP = maSP;
            this.TenSP = tenSP;
            this.Mau = mau;
